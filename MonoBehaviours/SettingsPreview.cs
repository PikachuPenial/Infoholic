        ...
        {
            {
                if (Infoholic.inSettings)
                {
                    ...
                    healthText.gameObject.transform.position = new Vector3(6f + Infoholic.TextX, (-14f + Infoholic.TextY) + Infoholic.FontSpacing, 0f);

                    livesText.gameObject.transform.position = new Vector3(6f + Infoholic.TextX, (-15f + Infoholic.TextY) + Infoholic.FontSpacing, 0f);

                    blockCooldownText.gameObject.transform.position = new Vector3(6f + Infoholic.TextX, (-16f + Infoholic.TextY) + Infoholic.FontSpacing, 0f);

                    damageText.gameObject.transform.position = new Vector3(6f + Infoholic.TextX, (-17f + Infoholic.TextY) + Infoholic.FontSpacing, 0f);

                    lifeStealText.gameObject.transform.position = new Vector3(6f + Infoholic.TextX, (-18f + Infoholic.TextY) + Infoholic.FontSpacing, 0f);
